...
task_created = django.dispatch.Signal(use_caching=True)
task_error = django.dispatch.Signal()
task_rescheduled = django.dispatch.Signal(use_caching=True)
task_failed = django.dispatch.Signal()
task_successful = django.dispatch.Signal(use_caching=True)
task_started = django.dispatch.Signal(use_caching=True)
